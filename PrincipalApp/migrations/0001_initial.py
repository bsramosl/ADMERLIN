# Generated by Django 3.2.9 on 2022-05-12 13:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cli', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PrincipalApp.client')),
            ],
            options={
                'verbose_name': 'Venta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PrincipalApp.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', models.DecimalField(decimal_places=2, default=0.0, max_digits=9)),
                ('prod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PrincipalApp.product')),
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PrincipalApp.sale')),
            ],
            options={
